...
/**
 * tree_size_h - Function to  measure the sum of heights of a binary tree
 * @tree: pointer to the root node of the tree to measure the height
 * Return: 0 if tree is NULL, otherwise NULL
 */
...
/**
 * _preorder - Function to check binary tree using pre-order traversal
...
/**
 * heap_extract - Function to extract the root node from a Max Binary Heap
